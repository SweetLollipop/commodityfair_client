  ...
  <header class="header">
    ...
    <div class="top">
      <div class="container">
        ...
        <div class="typeList">
          <a @click="$router.push('/center/myorder')" style="cursor:pointer">我的订单</a>
          <a @click="$router.push('/shopcart')" style="cursor:pointer">我的购物车</a>
          <a href="###">我的尚品汇</a>
          <a href="###">尚品汇会员</a>
          <a href="###">企业采购</a>
          <a href="###">关注尚品汇</a>
...
export default {
  ...
  methods: {
    goSearch() {
      ...
      //如何指定params参数可以传递、或者不传递，在配置路由的时候，在占位的后面加上一个问号【params可以传递参数或不传】

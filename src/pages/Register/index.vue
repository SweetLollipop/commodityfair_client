    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <input
          ...
          v-model="phone"
          name="phone"
          v-validate="{ required: true, regex: /^[1][3,4,5,6.7,8,9][0-9]{9}$/ }"
      ...
      <div class="content">
        ...
        <input
          ...
          :class="{ invalid: errors.has('passwd') }"
        />
        <span class="error-msg">{{ errors.first("passwd") }}</span>
      </div>
      <div class="controls">
        <input
          type="checkbox"
...
<script>
  export default {
    ...
    methods: {
      ...
      //用户的注册
      async userRegister() {
        const success = await this.$validator.validateAll(); //全部表单验证通过才能提交发请求
        try {
